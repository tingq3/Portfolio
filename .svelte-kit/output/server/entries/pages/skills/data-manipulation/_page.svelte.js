...
function _page($$payload, $$props) {
  ...
  const project = {
    ...
    description: "Data manipulation involves transforming, cleaning, organizing, and restructuring raw data into a usable format for analysis and insights.",
    tags: { Skills: ["Statistical-Analysis"] }
  };
  const each_array = ensure_array_like(Object.entries(project.tags));
  Header($$payload, { path: "skills/data-manipulation" });
