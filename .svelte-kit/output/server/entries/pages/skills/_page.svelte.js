...
function _page($$payload) {
  const sections = [
    ...
    },
    {
      ...
      path: "/skills/object-oriented-programming",
      class: "orange",
  ...
  Header($$payload, { path: "Portfolio/skills" });
